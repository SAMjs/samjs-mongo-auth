    ...
    samjs.mongo.plugins({
      auth: function(options) {
        ...
        return this.addHook("beforePopulate", function(obj) {
          var allowed, forbidden, i, len, modelname, populate, ref, ref1, ref2, ref3, ref4, ref5, schemaobj;
          ref = obj.populate;
          for (i = 0, len = ref.length; i < len; i++) {
            populate = ref[i];
            modelname = populate.model;
            if (modelname == null) {
              schemaobj = this.schema.path(populate.path);
              if (schemaobj != null) {
                modelname = (ref1 = schemaobj.options) != null ? ref1.ref : void 0;
                if (modelname == null) {
                  modelname = (ref2 = schemaobj.caster) != null ? (ref3 = ref2.options) != null ? ref3.ref : void 0 : void 0;
                }
              }
            }
            if ((modelname != null) && (((ref4 = samjs.models[modelname]) != null ? ref4.processAuth : void 0) != null)) {
              ref5 = samjs.models[modelname].processAuth(obj, "read"), forbidden = ref5.forbidden, allowed = ref5.allowed;
